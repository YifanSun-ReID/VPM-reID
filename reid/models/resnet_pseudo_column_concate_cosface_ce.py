...
import numpy as np
import pdb
__all__ = ['resnet50_pseudo_column_concate_cosface_ce']
...
class ResNet(nn.Module):
    ...
    def __init__(self, depth, pretrained=True, cut_at_pooling=False,
        ...
        if self.FCN:
            ...
            self.part_classifier = nn.Linear(self.num_features*self.num_parts, self.num_classes)
...
def resnet50_pseudo_column_concate_cosface_ce(**kwargs):
